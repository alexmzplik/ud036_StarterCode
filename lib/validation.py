...
class Validate(object):
    ...
    def is_valid_url(value):
        ''' check if the keyword argument value (string) is a validade a valid url using regular expression '''
    ...
    def is_valid_year(year):
        ...
        TODO: it's only checking if the value is a number and is higher than zero, so we need to discover a better way to determine what a year represents.
        '''
        regex = compile(r'^\d+$')
